...
class TestAutomatedTesterQuality(unittest.TestCase):
    def test_automated_tester_tracks_phase_history_and_analysis_summary(self):
        tester = AutomatedTester({"minimum_stable_pass_rate": 0.8, "export_contract_version": "d23.v1"})
        ...
        self.assertEqual(performance_report["report_metadata"]["contract_version"], "d23.v1")

    def test_automated_tester_export_uses_json_safe_contract(self):
        tester = AutomatedTester({"export_contract_version": "d23.v1"})
        tester.add_test_suite(
            "export-suite",
            [
                {
        ...
        self.assertEqual(payload["report_metadata"]["contract_version"], "d23.v1")
