...
测试基线（2026-04-21 更新）：3046 passed / 0 failed / 4 xfailed / 2 skipped / 175 warnings。
...
2. 确认 3046+ pass / 0 fail / 4 xfail / 2 skip
3. 如需先补验证面，执行 `test_kg_e2e.py` 对 live `/api/analysis/kg/stats` 与 graph asset 输出做一次实跑确认
4. 按 Phase G-3 -> G-4 -> H-1 -> I-2 顺序继续推进
