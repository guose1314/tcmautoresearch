...
def test_research_methods():
    ...
    # ─────────────────────────────────────────────────────────────────────────
    # 【方法1】方剂结构分析 - Formula Structure Analysis
    # ─────────────────────────────────────────────────────────────────────────
    ...
    # ─────────────────────────────────────────────────────────────────────────
    # 【方法2】药物性味与归经 - Herb Properties & Meridian Entry
    # ─────────────────────────────────────────────────────────────────────────
    ...
    for meridian in meridians:
        herbs = HerbPropertyDatabase.get_herbs_by_meridian(meridian)
        print(f"  {meridian}: {', '.join(herbs)}")
    
    # ─────────────────────────────────────────────────────────────────────────
    # 【方法3】类方比较 - Similar Formula Comparison
    # ─────────────────────────────────────────────────────────────────────────
    print("\n[METHOD 3] Similar Formula Comparison (Lei Fang Bi Jiao)")
    print("-" * 80)
    
    comparison_pairs = [("补中益气汤", "四君子汤"), ("四君子汤", "六君子汤")]
    
    for f1, f2 in comparison_pairs:
        # 检查是否需要交换顺序
    ...
    # ─────────────────────────────────────────────────────────────────────────
    # 【方法4】现代药理学与临床研究 - Modern Pharmacology & Clinical Research
    # ─────────────────────────────────────────────────────────────────────────
    ...
    # ─────────────────────────────────────────────────────────────────────────
    # 【综合分析】多维度集成研究 - Integrated Research Analysis
    # ─────────────────────────────────────────────────────────────────────────
    ...
    for formula_name in ["补中益气汤"]:
        ...
        for herb, prop in list(props.items())[:3]:
            if prop:
                print(f"     - {herb}: {prop.get('temperature')} {prop.get('flavors')} "
                      f"-> {', '.join(prop.get('meridians', []))}")
