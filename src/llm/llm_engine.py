...
class LLMEngine:
    ...
    RTX 4060 Laptop GPU（8 GB VRAM）在 4096 上下文下全量卸载 Qwen1.5-7B-Chat Q8_0
    容易逼近显存上限，因此默认保留少量层在 CPU 侧，优先稳定性。
    ...
    def __init__(
        ...
        Args:
            ...
            n_gpu_layers: GPU 卸载层数。0 = 纯 CPU；较大值 = 更多层驻留 GPU。
